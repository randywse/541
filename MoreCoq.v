...
(* -- rewrite applies pattern matching to the proof while apply uses 
hypothesis, lemma, or contructor. Apply can specify values for variables
that cannot be determined by pattern matching. 

     Yes, there are situations where both can apply. for example when there
exists patterns that can be matched by hypothesis, lemma, etc.*) 
...
Proof.
  ...
  Case "f1 = true". remember (f true) as f2.
   ...
   SCase "f2 = false". destruct b. 
      SSCase "b = true". rewrite <- Heqf1 in Heqf2. 
      inversion Heqf2.
      SSCase "b = false". symmetry in Heqf1. 
      apply Heqf1.
