...
(* when n is even, induction can be performed on n instead E. *)
...
(* Not working. The induction principle for inductively defined 
propositions does not follow quite the same form as that of 
...
(* it does induction to natural numbers, which will not work*)
*)
(** [] *)
